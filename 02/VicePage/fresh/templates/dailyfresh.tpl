        ...
        <div class="content clearfix">
            ...
            <div class="product-list">
                <ul class="list clearfix">
                    {foreach from=$product item=value key=key name=name max=5}
                        <li class="item">
                            <a href="javascript:;"><img src="./images/{$value.img}"></a>
                            <span class="price">{$value.price}</span>
                            <a href="javascript:;" class="info">{$value.msg}</a>
                            <p class="buy">
                                <a href="javascript:;" class="buy1">已评价<span>{$value.charge}次</span></a>
